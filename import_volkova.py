...
data = data.rename(columns={'profile_image_url_https': 'urls',
                            'id_str': 'id'})
...
data['image'].to_pickle('data/volkova_images.pkl')
data.to_pickle('data/volkova_complete.pkl')
